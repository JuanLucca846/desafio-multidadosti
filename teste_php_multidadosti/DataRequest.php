...
if (isset($_POST['tipo'])) {
    ...
    foreach ($dados as $chave => $valor) {
        $html .= '<tr>';
        $html .= '<td>' . ($chave + 1) . '</td>';
        $html .= '<td>' . (isset($valor['nome']) ? $valor['nome'] : '') . '</td>';
        $html .= '<td>' . (isset($valor['cpf']) ? $valor['cpf'] : '') . '</td>';
        $html .= '<td>' . (isset($valor['endereco']) ? $valor['endereco'] : '') . '</td>';
        $html .= '<td>' . (isset($valor['telefone']) ? $valor['telefone'] : '') . '</td>';
        $html .= '<td>' . (isset($valor['email']) ? $valor['email'] : '') . '</td>';
        $html .= '</tr>';
    }
